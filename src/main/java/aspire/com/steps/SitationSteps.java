...
public class SitationSteps extends BaseSteps {
	...
	@Given("clicking on The $element")
	@When("clicking on The $element")
	@Then("clicking on The $element")
	public void clickCookie(@Named("element") String element) throws IOException, Exception {
		getScitationPage().clickCookie(element);
	}
