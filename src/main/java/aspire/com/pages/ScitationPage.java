...
public class ScitationPage extends FluentWebDriverPage {
	...
	public boolean waitPresenceOfElementCoo(String element) throws IOException {
		boolean result = true;
	...
	public void clickCookie(String element) throws IOException {

		WebDriver driver = getDriverProvider().get();
		try {
			if (waitPresenceOfElementCoo("cookie")) {
